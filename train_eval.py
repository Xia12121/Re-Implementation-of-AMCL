...
def parse_option():
    ...
    parser.add_argument("--AMCL", type=str, default="N", help="N, Y")
    ...
    # 这里的augs是指的数据增强的方式，比如a是指最小尺度，b是指高斯模糊，c是指随机灰度，d是指颜色抖动，e是指水平翻转
