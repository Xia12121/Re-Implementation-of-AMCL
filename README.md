...
Author declaim AMCL method can be applied to four mainstream SSL method: SimCLR, MoCo, SimSiam, and B.Twins. This section will illustrate them all respectively.
